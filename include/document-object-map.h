...
template <bool orderedMap>
struct ObjectMapBase;

template <>
struct ObjectMapBase<true> : Object {
  ...
  struct iterator {
    Property* cproperty;
    inline iterator(ObjectMapBase* obj) {
...
template <>
struct ObjectMapBase<false> : Object {
  ObjectSymbol* classname;
  Property** hashmap;
  int32_t limit;
  int32_t shift;
  ...
  struct iterator {
    ...
    Property* cproperty;
    inline iterator(ObjectMapBase* obj) {
      this->cproperty = (Property*)SoftDoc_Utils::EndOfPtr;
    ...
    inline Property* begin() {
      ...
      if (this->cproperty == SoftDoc_Utils::EndOfPtr) return 0;
      return this->cproperty;
    }
    inline Property* next() {
      _ASSERT(this->chashmap[0] != SoftDoc_Utils::EndOfPtr && this->cproperty != SoftDoc_Utils::EndOfPtr);
      if (!(this->cproperty = this->cproperty->next)) {
        do { this->chashmap++; } while (!this->chashmap[0]);
        if ((this->cproperty = this->chashmap[0]) == SoftDoc_Utils::EndOfPtr) return 0;
      }
      return this->cproperty;
    }
  };
  ...
  __forceinline void init_hashmap(Document* document) {
    ...
    new_map[2] = 0;
    new_map[3] = 0;
    new_map[4] = (Property*)SoftDoc_Utils::EndOfPtr;
  ...
  void expand_hashmap(Document* document) {
    ...
    for (Property** cur_map = old_map; cur_map[0] != SoftDoc_Utils::EndOfPtr; cur_map++) {
    ...
    new_map[0] = (Property*)SoftDoc_Utils::EndOfPtr;
